...
//     // 1. 區間鐵律：若 結束時間 < 開始時間，兩者自動對調 (例如 12:00-11:00 變成 11:00-12:00)
...
//     // 2. 排序鐵律：按「開始時間」由早到晚嚴格排序
//     processedItems.sort((a, b) => a.startTime.localeCompare(b.startTime));

//     // 3. 連續性鐵律：後一個景點的開始時間若小於前一個，強制推移至與前一個相同，確保絕對遞增
...
//                           <input type="number" step="0.0001" value={rate} onChange={(e) => setRates({...rates, [cur]: Number(e.target.value)})} className="bg-transparent outline-none w-full text-white" />
//                         </div>
//                       ))}
//                     </div>
//                   </div>
